...
namespace SampleListBuilder
{
    public static class SampleListHelper
    {
        ...
        private static Dictionary<string, string> CategoryFolders = new Dictionary<string, string>()
        {
            ...
            { "Services Module", "Take advantage of the Services module to simplify integration of the REST services with the Azure Maps Web SDK." },
            { "Spatial Analysis", "Gain deep insights with in-depth spatial analysis of data." },
            ...
            { "Spatial Math", "Learn how to perform common spatial calculations easily with the Azure Maps Web SDK." },
